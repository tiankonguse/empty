...
def readData(ret, peopleList):
    try:
        f = open("../data/room_again_aa", 'r')
        f_ex = open("../data/room_again_aa_ex", 'w')
...
if __name__ == "__main__":
    if not lockFile("import_room_data.lock.pid"):  
        sys.exit(0) 
    main ( )
